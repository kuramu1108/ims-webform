<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyInterventions.aspx.cs" Inherits="InterventionManagementSystem.Engineer.MyInterventions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <h3>Intervention List -<%=getDetail().Name %></h3>
